...
import static com.infotech.utils.Util.isInRange;
...
public class ZipCodeRange implements Comparable<ZipCodeRange> {
	 ...
	 * 
	 * @param range
	 *            A string of exactly two ZIP code values in the format of
	 *            [#####,#####]
	 * @throws IllegalArgumentException
	 *             when the format of the range is incorrect
	 *
	 *             Note: the [] are optional and there may be any amount of
	 *             whitespace before/after the comma and within the brackets
	 */
	 ...
	 * 
	 * @param range
	 *            An int[] of exactly two ZIP code values ranging from 0-99999,
	 *            representing the start and end range
	 * @throws IllegalArgumentException
	 *             when the ZIP code value is not within the supported range
	 */
	 ...
	 * 
	 * @param range
	 *            A List&lt;Integer&gt; of exactly two ZIP code values ranging
	 ...
	 * 
	 * @param range
	 *            The ZipCodeRange object to be copied
	 ...
	 * 
	 * @param range
	 *            the ZipCodeRange object to be compared
	 * @return a negative integer, zero, or a positive integer as this object is
	 *         less than, equal to, or greater than the specified object
	 */
	@Override
	public int compareTo(ZipCodeRange range) {
		return Comparator.comparing(ZipCodeRange::getStart).thenComparing(ZipCodeRange::getEnd).compare(this, range);
	}
	...
	/**
	 * Return the ZipCodeRange as a String in the format of
	 * {@code [00000,99999]}.
	 * 
	 * @return An int[] containing the start and end values for this object
	 */
	...
	/**
	 * Checks if the specified ZipCodeRange can be merged with this instance
	 * (adjacent or overlaps either the start or end).
	 * 
	 * @param merge
	 *            The ZipCodeRange object to check against
	 * @return true if either the start or end of the specific range overlaps
	 *         the current range
	 */
	public boolean isMergeable(ZipCodeRange merge) {
		boolean result = false;
		if (merge != null) {
			result = ((merge.end + 1 == this.start) || (merge.start - 1) == this.end || isInRange(merge.start, this)
					|| isInRange(merge.end, this) || isInRange(this.start, merge));
		}
		return result;
	}
	 ...
	 * 
	 * @param range
	 *            The ZipCodeRange object to merge into this instance
	 */
